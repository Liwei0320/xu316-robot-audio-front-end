...
/* Capture-only UAC2 device. The processed mono beam is duplicated to stereo. */
...
/*
 * Four microphones are connected to bits 4..7 of the 8-bit PDM input port.
 * They are SDR microphones: one microphone per data pin.
 */
