...
/* Capture-only UAC1 device: stereo beam output plus four raw PDM references. */
#define NUM_USB_CHAN_OUT                 0
#define NUM_USB_CHAN_IN                  6
#define NUM_USB_CHAN_IN_FS               6
...
/*
 * DATA0..DATA3 occupy bits 4..7 of the 8-bit PDM input port. Four PDM inputs
 * are captured before user processing. USB channels 1-2 carry the beam and
 * channels 3-6 retain DATA0-DATA3 for host-side verification.
 */
#define XUA_NUM_PDM_MICS                 4
#define XUA_NUM_PDM_MICS_IN              8
#define XUA_PDM_MIC_USE_DDR              0
#define XUA_PDM_MIC_USE_PDM_ISR          0
#define XUA_PDM_MIC_NUM_DECIMATOR_SUBTASKS 2
...
#define PRODUCT_STR_A2                   "XU316 4Mic Beam + Raw 6Ch 1"
#define PRODUCT_STR_A1                   "XU316 4Mic Beam + Raw 6Ch 1"
/* A distinct PID prevents Windows from reusing a cached two-channel endpoint. */
#define PID_AUDIO_2                      0x0334
#define PID_AUDIO_1                      0x0335
#define DFU_PID                          0xE334
