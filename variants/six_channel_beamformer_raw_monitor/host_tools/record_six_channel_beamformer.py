...
SAMPLE_RATE = 48000
CHANNELS = 6
DEVICE_NAME_TOKEN = "XU316 4Mic Beam + Raw 6Ch"
    ...
    while True:
        ...
        for index, device in enumerate(devices):
            ...
            if (
                ...
                and DEVICE_NAME_TOKEN in name
            ):
                return index, name

        if time.monotonic() >= deadline:
            raise RuntimeError(
                "XU316 six-channel beamformer was not found after 30 seconds. "
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Record the six-channel XU316 beam-plus-raw output."
    )
    parser.add_argument(
...
def main():
    ...
    print("Channels: beam, beam, DATA0, DATA1, DATA2, DATA3")
