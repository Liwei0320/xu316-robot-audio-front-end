...
#if BF_FOUR_MIC_BRINGUP && (MIC_ARRAY_CONFIG_MIC_COUNT != BF_MIC_COUNT)
#error BF_FOUR_MIC_BRINGUP requires DATA0 through DATA3.
#endif
...
{
#if BF_FOUR_MIC_BRINGUP
    mic_audio[0] = scale_mic(mic_audio[0], BF_FOUR_MIC_GAIN_DATA0);
    mic_audio[1] = scale_mic(mic_audio[1], BF_FOUR_MIC_GAIN_DATA1);
    mic_audio[2] = scale_mic(mic_audio[2], BF_FOUR_MIC_GAIN_DATA2);
    mic_audio[3] = scale_mic(mic_audio[3], BF_FOUR_MIC_GAIN_DATA3);
    return;
#else
