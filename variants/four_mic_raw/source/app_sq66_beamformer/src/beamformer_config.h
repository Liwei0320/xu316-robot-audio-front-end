...
/* Four-microphone bring-up: DATA0..DATA3 -> USB channels 1..4. */
#define BF_FOUR_MIC_BRINGUP              1
#define BF_FOUR_MIC_GAIN_DATA0           64
#define BF_FOUR_MIC_GAIN_DATA1           64
#define BF_FOUR_MIC_GAIN_DATA2           64
#define BF_FOUR_MIC_GAIN_DATA3           64
