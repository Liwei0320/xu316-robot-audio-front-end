...
/* Capture-only UAC1 device. DATA0..DATA3 are independent USB channels. */
#define NUM_USB_CHAN_OUT                 0
#define NUM_USB_CHAN_IN                  4
#define NUM_USB_CHAN_IN_FS               4
 ...
 * captures DATA0..DATA3 as four SDR microphones, one microphone per pin.
 */
...
#define PRODUCT_STR_A2                   "XU316 Four Mic Audio Test 1"
#define PRODUCT_STR_A1                   "XU316 Four Mic Audio Test 1"
/* A fresh PID prevents Windows from reusing the cached two-channel endpoint. */
#define PID_AUDIO_2                      0x032A
#define PID_AUDIO_1                      0x032B
#define DFU_PID                          0xE32A
