...
2026-08-10 已完成 XTAG4 RAM 加载、Windows USB 枚举和 20 秒连续静音基线录音。固件已进入波束算法分支且 USB 传输持续运行，但静音录音不能证明四路麦克风都正确参与；还需要逐麦激励和正面/侧面标准声源测试，因此不能把本版本称为已经转向某个具体角度的量产波束固件。
...
| 产品名 | `XU316 4Mic Broadside Beam 1` |
