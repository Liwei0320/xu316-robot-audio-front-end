...
/* Capture-only UAC1 device. The processed mono beam is duplicated to stereo. */
 ...
 * are processed into the first two slots before audiohub sends them to USB.
 */
...
#define PRODUCT_STR_A2                   "XU316 4Mic Broadside Beam 1"
#define PRODUCT_STR_A1                   "XU316 4Mic Broadside Beam 1"
/* A fresh PID prevents Windows from reusing a cached raw-capture endpoint. */
#define PID_AUDIO_2                      0x032C
#define PID_AUDIO_1                      0x032D
#define DFU_PID                          0xE32C
